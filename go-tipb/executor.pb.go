...
type TableScan struct {
	...
	NeedMvcc               bool                  `protobuf:"varint,8,opt,name=need_mvcc,json=needMvcc" json:"need_mvcc"`
	FlashbackTimestamps    []*FlashbackTimestamp `protobuf:"bytes,9,rep,name=flashback_timestamps,json=flashbackTimestamps" json:"flashback_timestamps,omitempty"`
	XXX_unrecognized       []byte                `json:"-"`
}
...
func (m *TableScan) GetNeedMvcc() bool {
	if m != nil {
		return m.NeedMvcc
	}
	return false
...
func (m *TableScan) GetFlashbackTimestamps() []*FlashbackTimestamp {
	if m != nil {
		return m.FlashbackTimestamps
	}
	return nil
}

type FlashbackTimestamp struct {
	Start            uint64 `protobuf:"varint,1,req,name=start" json:"start"`
	End              uint64 `protobuf:"varint,2,req,name=end" json:"end"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *FlashbackTimestamp) Reset()                    { *m = FlashbackTimestamp{} }
func (m *FlashbackTimestamp) String() string            { return proto.CompactTextString(m) }
func (*FlashbackTimestamp) ProtoMessage()               {}
func (*FlashbackTimestamp) Descriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{4} }

func (m *FlashbackTimestamp) GetStart() uint64 {
	if m != nil {
		return m.Start
	}
	return 0
...
func (m *FlashbackTimestamp) GetEnd() uint64 {
	if m != nil {
		return m.End
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*FlashbackTimestamp)(nil), "tipb.FlashbackTimestamp")
...
func (m *TableScan) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	if len(m.FlashbackTimestamps) > 0 {
		for _, msg := range m.FlashbackTimestamps {
			dAtA[i] = 0x4a
			i++
			i = encodeVarintExecutor(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *FlashbackTimestamp) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *FlashbackTimestamp) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	dAtA[i] = 0x8
	i++
	i = encodeVarintExecutor(dAtA, i, uint64(m.Start))
	dAtA[i] = 0x10
	i++
	i = encodeVarintExecutor(dAtA, i, uint64(m.End))
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
	return i, nil
...
func (m *TableScan) Size() (n int) {
	...
	n += 2
	if len(m.FlashbackTimestamps) > 0 {
		for _, e := range m.FlashbackTimestamps {
			l = e.Size()
			n += 1 + l + sovExecutor(uint64(l))
		}
	}
...
func (m *FlashbackTimestamp) Size() (n int) {
	var l int
	_ = l
	n += 1 + sovExecutor(uint64(m.Start))
	n += 1 + sovExecutor(uint64(m.End))
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	return n
...
func (m *TableScan) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NeedMvcc", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FlashbackTimestamps", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FlashbackTimestamps = append(m.FlashbackTimestamps, &FlashbackTimestamp{})
			if err := m.FlashbackTimestamps[len(m.FlashbackTimestamps)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *FlashbackTimestamp) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FlashbackTimestamp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FlashbackTimestamp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorExecutor = []byte{
	...
	,
}
